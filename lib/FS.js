...
(function() {
  ...
  this.resolve_route = function(route) {
    return njs_path.resolve(process.cwd(), route);
  };

  this.mkdirp = function(route, handler) {
    if (handler == null) {
      handler = null;
    }
    ...
    if (handler != null) {
      return MKDIRP.sync(route, handler);
    }
    return MKDIRP(route, handler);
  };
